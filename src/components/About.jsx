    ...
    const data = [
        {
            ...
            description: 'HTML, CSS, JavaScript, React.js, Python',
        },
        {
            name: 'Education',
        ...
        },
        {
            ...
            description: 'Designed and developed multiple high-quality projects with modern technologies.',
        },
    ];
    return (
        <div id="about" className="w-full px-[12%] py-10 scroll-mt-20">
            ...
            <div className="flex w-full flex-col lg:flex-row items-center gap-20 my-20">
                <div className="max-w-max mx-auto relative">
                    <img src='./assets/photo1 (4).jpeg' alt="" className="w-64 sm:w-80 rounded-3xl max-w-none" />
                    ...
                    <span className="w-1/4 absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">🧑‍💻</span>
                    </div>
                </div>
                <div className="flex-1">
                    <p className="mb-10 max-w-2xl font-Ovo">I’m a Frontend Developer passionate about creating clean, responsive, and engaging user interfaces, with hands-on experience in Machine Learning and AI development. I enjoy combining design, performance, and intelligent data-driven solutions to build impactful digital products.</p>
