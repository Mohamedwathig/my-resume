        ...
        <div className="mt-20">
            <div className="text-center">
                ...
                <div className="w-max flex items-center gap-2 mx-auto">
                    ...
                    <a href="Mohamedwathig3@gmail.com">Mohamedwathig3@gmail.com</a>
                </div>
            </div>
            <div className="text-center sm:flex items-center justify-between border-t border-gray-400 mx-[10%] mt-12 py-3">
                <p>© {new Date().getFullYear()} <a href="https://prebuiltui.com">PrebuiltUI</a>. All rights reserved.</p>
                <ul className="flex items-center gap-10 justify-center mt-4 sm:mt-0">
                    <li><a target='_blank' href="https://github.com/Mohamedwathig">GitHub</a></li>
                    <li><a target='_blank' href="https://www.linkedin.com/in/mohamed-elyass-238a98365/">LinkedIn</a></li>
                </ul>
            </div>
        </div>
    )
